...
function makeResponsive() {
    ...
    var area = d3.area()
        ...
        .y0(height)
        .y1(function(d) { return y(d.accuracy); });

    var area2 = d3.area()
        .curve(d3.curveMonotoneX)
        .x(function(d) { return x(d.epoch); })
        .y0(height2)
        .y1(function(d) { return y2(d.accuracy); });
    ...
    // var line2 = d3.line()
    //     .curve(d3.curveMonotoneX)
    //     .x(function(d) { return x2(d.epoch)})
    //     .y(function(d) { return y2(d.accuracy)});
    ...
    d3.json(url, function(error, data) {
        ...
        y.domain([d3.min(data, function(d) { return d.accuracy}), d3.max(data, function(d) { return d.accuracy})]);
        ...
        d3.select("#start").on("click", function() {
            ...
            path
                ...
                .ease(d3.easeBounceInOut) // Set Easing option
            ...
            //     console.log('x0',x0)
            // focusTip.attr("transform", "translate(" + x(new Date(d.start_year,0,1)) + "," + y(d.accuracy) + ")");
            // focusTip.select("text").text(d.accuracy);
            // }
        });
